...
```
800 ++--------+---------+---------+--------+---------+---------+--------A+
      +         +         +        "joviansatellites.csv" using 2:3 **AAAA +
  700 ++                                                            *AAA  ++
      |                                                           **       |
      |                                                       *AAA         |
  600 ++                                                    **            ++
...
```
####HandsOn 13
Adams-Bashforth Tercer Orden
[Cuaderno de Ipython con Soluciones](https://github.com/marojas11/MC/blob/master/HandsOn/13/HandsOn13.ipynb)
...
Taller 7 - El Atractor de Rössler 


[Cuaderno de Ipython con Soluciones](https://github.com/marojas11/MC/blob/master/Talleres/Taller7/Taller7.ipynb)
...
#### Propuesta de Proyecto final Métodos Computacionales.
